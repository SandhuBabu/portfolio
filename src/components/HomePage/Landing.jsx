...
const nameHover = {
  ...
  color: 'black',
  background: 'black',
  textShadow: '-1px -1px 0 #a956f7fe, 1px -1px 0 #a956f7fe,-1px  1px 0 #a956f7fe,1px  1px 0 #a956f7fe',
  y: -30
}
    ...
    <section className='w-full text-center md:text-justify h-screen grid place-items-center'>
      <div className='relative'>
        <motion.h1
          ...
          className={`tracking-[1px] text-[3em] font-bold text-purple-400 flex flex-col md:flex-row gap-4 cursor-pointer`}
        ...
        <div className='flex gap-2 mt-5 justify-center md:justify-start'>
          ...
          className={`hover:text-${colors.main} text-xl`}
        ...
        <motion.button
          whileTap={{
            ...
            rotateZ: '5deg',
            rotateY: '10deg',
            boxShadow: '10px 3px 25px #9727ff',
            background:'black'
          }}
          transition={{ duration: 0.5, delay: 0.1 }}
          className={`bg-purple-400 text-white w-[14em] h-[4em] mt-[2em] rounded-md font-medium shadow-xl`}
        >Contact Me
        </motion.button>
      </div>
    </section>
